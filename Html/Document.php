...
class Document {
	...
	public function addLink( $Link ) {
		if ( !( $Link instanceof Link ) ) {
			error_log( __METHOD__ . '() $Link provided is not a valid Penn\Html\Link' );
	...
	public function addMeta( $Meta ) {
		if ( !( $Meta instanceof Meta ) ) {
			error_log( __METHOD__ . '() $Meta provided is not a valid Penn\Html\Meta' );
			throw new Exception( 'parameter type error', 1 );
		}
	...
	public function addScript( $Script, $placement = 'body' ) {
		if ( !( $Script instanceof Script ) ) {
			error_log( __METHOD__ . '() $Script provided is not a valid Penn\Html\Script' );
			throw new Exception( 'parameter type error', 1 );
		}
